...
Shader::Shader()
{
	...
	glUseProgram(shaderProgram); //1282
	...
	glVertexAttribPointer(colAttrib, 3, GL_FLOAT, GL_FALSE, 9 * sizeof(float),
						  (void *)(3 * sizeof(float)));

	GLint normAttrib = glGetAttribLocation(shaderProgram, "normal");
	glEnableVertexAttribArray(normAttrib);
	glVertexAttribPointer(normAttrib, 3, GL_FLOAT, GL_FALSE, 9 * sizeof(float),
						  (void *)(6 * sizeof(float)));
